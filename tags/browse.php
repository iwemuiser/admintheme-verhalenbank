...
<?php if ($total_tags): ?>
    ...
    <?php endif; ?>
        ...
        <ul class="quick-filter-wrapper">
            <li><a href="#" tabindex="0"><?php echo __('Page'); ?></a>
            <ul class="dropdown">
                <li><span class="quick-filter-heading"><?php echo __('Page number') ?></span></li>
                <?php foreach($pages as $pg): ?>
                    <?php $st = $pg*$per_page; ?>
                    <li><a href="<?php echo url('tags', array('page' => $pg)); ?>"><?php echo $pg . ": >". $st; ?></a></li>
                <?php endforeach; ?>
            </ul>
            </li>
        </ul>
